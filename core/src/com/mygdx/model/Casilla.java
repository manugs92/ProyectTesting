    ...
    public void addListenerToBoard(Tablero tablero, Partida partida, int x2, int y2) {
        this.imageCasilla.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                //((Criatura) selectedCard).getTipo();


//                switch (selectedCard.getTipo()) {
//
//                    case CRIATURA:
...
//                }
                ...
                //si la carta seleccionada no es nula, donde intento colocarla esta vacia y si es interactuable(a nuestro alcance y no esta ocupada por un monstruo)
                if (selectedCard != null  && Casilla.this.getCriatura() == null && Casilla.this.getState() != 0) {
                    ...
                    if (selectedCard.getLastPosition().x != -1 && selectedCard.getLastPosition().y != -1 && !selectedCard.getTipo().equals("TRAMPA")) {
                        ...
                        tablero.getCasilla((int) selectedCard.getPosition().x, (int) selectedCard.getPosition().y).getCriatura().setLastPosition(-1, -1);
                    }

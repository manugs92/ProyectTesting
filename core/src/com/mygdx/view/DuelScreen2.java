...
// * */
//public class DuelScreen2 implements Screen {
//
//
//    //Variables back end.
...
//    private Texture textureBgScreen,textureCasilla,textureBgScroll,textureCard,textureSpriteCard;
...
//    private ArrayList<Image> criaturasInvocadas = new ArrayList<>();
...
//
//
//    public DuelScreen2(ScreenManager screenManagerR) {
...
//        tablero.setCasilla(1,0,criatura,0);
//
//
//        /*GUI de la vista*/
...
//        textureBgScreen = new Texture(Gdx.files.internal("backgrounds\\bg2.jpg"));
...
//            @Override
//            public void clicked(InputEvent event2, float x, float y) {
...
//            final int finali = i;
//
//            addListenersToHand(i, finali);
//
//            stage.addActor(cartasManoJ1GUI[i]);
//        }
//    }
//
//    private void addListenersToHand(int i, int finali) {
//        cartasManoJ1GUI[i].addListener(new ClickListener() {
//            @Override
//            public void clicked(InputEvent event, float x, float y) {
//                Casilla[][] casillas = tablero.getCasillas();
//                for(int i=0;i<=casillas.length-1;i++) {
//                    //mostramos las casillas vacias
//                    if(tablero.getCasilla(i,0).getCriatura()==null) {
//                        casillasTableroGUI[i][0].setColor(255,25,55,255);
//                    }
//                }
